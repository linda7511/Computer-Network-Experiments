...
RrepHeader::RrepHeader (uint8_t prefixSize, uint8_t hopCount, Ipv4Address dst,
                        uint32_t dstSeqNo, Ipv4Address origin, Time lifeTime/*, *int32_t congestionFlag*/)//CC-AODV
  : m_flags (0),
    ...
    m_origin (origin)
{
  ...
  //m_congestionFlag = congestionFlag;//CC-AODV
}
...
RrepHeader::Serialize (Buffer::Iterator i) const
{
  ...
  //i.WriteHtonU32 (m_congestionFlag);//CC-AODV
}
...
RrepHeader::Deserialize (Buffer::Iterator start)
{
  ...
  //m_congestionFlag = i.ReadNtohU32 ();//CC-AODV
...
RrepHeader::Print (std::ostream &os) const
{
  ...
  os << " source ipv4 " << m_origin << " lifetime " << m_lifeTime /*<< " congestion flag " << m_congestionFlag*///CC-AODV
...
RrepHeader::operator== (RrepHeader const & o) const
{
  return (m_flags == o.m_flags && m_prefixSize == o.m_prefixSize
          ...
          && m_origin == o.m_origin && m_lifeTime == o.m_lifeTime /*&& m_congestionFlag == o.m_congestionFlag*/);//CC-AODV
}
