...
//#define MAX_CONGESTION_COUNT 4//CC-AODV
...
RoutingProtocol::GetTypeId (void)
{
  static TypeId tid = TypeId ("ns3::aodv::RoutingProtocol")
    ...
    /*.AddAttribute ("m_congestionCounter", "m_congestionCounter.",
                   ...
                   MakeUintegerChecker<uint32_t> ())*///CC-AODV
...
RoutingProtocol::SendReply (RreqHeader const & rreqHeader, RoutingTableEntry const & toOrigin)
{
  ...
  RrepHeader rrepHeader ( /*prefixSize=*/ 0, /*hops=*/ 0, /*dst=*/ rreqHeader.GetDst (),
                                          /*dstSeqNo=*/ m_seqNo, /*origin=*/ toOrigin.GetDestination (), /*lifeTime=*/ m_myRouteTimeout/*, 1*/);//CC-AODV
...
RoutingProtocol::RecvReply (Ptr<Packet> p, Ipv4Address receiver, Ipv4Address sender)
{
  ...
  RoutingTableEntry newEntry (/*device=*/ dev, /*dst=*/ dst, /*validSeqNo=*/ true, /*seqno=*/ rrepHeader.GetDstSeqno (),
                                          ...
                                          /*nextHop=*/ sender, /*lifeTime=*/ rrepHeader.GetLifeTime ()/*, rrepHeader.GetCongestionFlag()*/);//CC-AODV
  RoutingTableEntry toDst;
  if (m_routingTable.LookupRoute (dst, toDst))
    {
      /*
